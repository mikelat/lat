		...
		<li>
			<div class="cell">
				...
				<div class="statistics">
					<span class="threads"><abbr title="<?php echo Load::word('forum', 'threads') ?>"><?php echo Load::word('forum', 'stats_threads', String::number_format($forum['total_threads'])) ?></abbr></span>
					<span class="replies"><abbr title="<?php echo Load::word('forum', 'replies') ?>"><?php echo Load::word('forum', 'stats_replies', String::number_format($forum['total_replies'])) ?></abbr></span>
				</div>
